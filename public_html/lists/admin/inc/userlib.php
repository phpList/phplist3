...
*/
  ...
  # dbg("$field of type $type");
    ...
    if ($field && !$_SESSION['userdata'][$field]['value']) {
        ...
        break;
    } elseif ($required_formats[$index] && !preg_match(stripslashes($required_formats[$index]), $_SESSION['userdata'][$field]['value'])) {
        ...
        break;
    } elseif ($field == 'cardtype' && $_SESSION['userdata'][$field]['value'] == 'WSWITCH' && !preg_match("/\d/", $_SESSION['userdata']['attribute82']['value'])) {
