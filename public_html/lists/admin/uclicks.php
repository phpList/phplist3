...
if (!$id) {
    ...
    if ($some) {
        ...
        print '<div class="actions">' . PageLinkButton('uclicks&dl=true',
...
print '<div class="actions">' . PageLinkButton('uclicks&dl=true&id=' . $id,
        $GLOBALS['I18N']->get('Download as CSV file')) . '</div>';
...
#  if (CLICKTRACK_SHOWDETAIL) {
    $ls->addColumn($element, $GLOBALS['I18N']->get('clicks'),
