...
class test_is_email extends phplistTest
{
    ...
    public function runtest()
    {
        $emailAddresses = array(
            ...
            // Quoted string can be anything, as long as certain chars are escaped with \
            '"name last"@company.com' => true,
            // Quoted string can be anything, as long as certain chars are escaped with \
            '" "@company.com' => true,
            // Quoted string can be anything, as long as certain chars are escaped with \
            ...
            '.n@company.com' => false,
            // Starting dot is nok
            'n.n@company.com' => true,
            // dot is ok between text
            '@company.com' => false,
            // Local part too short
            'n@company.com' => true,
            // Local part not yet too short
            'abcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcd@company.com' => true,
            // Local part too long
            'abcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcde@company.com' => false,
            // Local part not yet too long
            'mailto:name@company.com' => false,
            // protocol included  @@ maybe support during import?
            'name,name@company.com' => false,
            // non-escaped comma
            'user1@domain1.com;user2@domain2.com' => false,
