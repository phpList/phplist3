...
if (REGISTER) {
    $PoweredByImage = '<table border="0" cellspacing="0" width="100%"><tr><td></td><td width="90"><p class="poweredby" style="text-align:center"><a style="display:inline-block;width:5%;max-width:90px;min-width:70px" href="https://www.phplist.com/poweredby?utm_source=pl' .$v. '&amp;utm_medium=poweredhostedimg&amp;utm_campaign=phpList" title="visit the phpList website" ><img src="' . PHPLIST_POWEREDBY_URLROOT.'/'.$v.'/power-phplist.png" width="100%" height="auto" title="powered by phpList version '.$v.', &copy; phpList ltd" alt="powered by phpList '.$v.', &copy; phpList ltd" border="0" /></a></p></td><td></td></tr></table>';
} else {
    $PoweredByImage = '<table border="0" cellspacing="0" width="100%"><tr><td></td><td width="90"><p class="poweredby" style="text-align:center"><a style="display:inline-block;width:5%;max-width:90px;min-width:70px" href="https://www.phplist.com/poweredby?utm_source=pl' .$v. '&amp;utm_medium=poweredlocalimg&amp;utm_campaign=phpList" title="visit the phpList website"><img src="images/power-phplist.png" width="100%" height="auto" title="powered by phpList version '.$v.', &copy; phpList ltd" alt="powered by phpList '.$v.', &copy; phpList ltd" border="0"/></a></p></td><td></td></tr></table>';
}
