...
switch ($page) {
  ...
  case 'message': $page_title = 'Campaign';break;
  ...
  case 'templates': $page_title = 'Campaign templates';break;
  ...
  case 'bouncemgt': $page_title = 'Bounce management'; break;
  case 'bounces': $page_title = 'Bounces';break;
  case 'bounce': $page_title = 'Bounce';break;
  ...
  case 'usermgt': $page_title = 'Subscriber management'; break;
  case 'domainstats': $page_title = 'Domain statistics'; break;
  case 'mviews': $page_title = 'Opens'; break;
  case 'statsmgt': $page_title = 'Statistics'; break;
