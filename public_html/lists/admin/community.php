...
<div class="tabbed">
    <ul>
        <li><a href="#opensource"><?php echo s('Open Source') ?></a></li>
        <li><a href="#gethelp"><?php echo s('How to get help') ?></a></li>
        <li><a href="#helpout"><?php echo s('Contribute') ?></a></li>
        <li><a href="#hosted">phpList Hosted</a></li>
    </ul>

    <div id="opensource">
        <h3><?php echo s('phpList is Open Source software') ?></h3>
    ...
    <div id="helpout">
        <h3><?php echo s('Contribute to phpList') ?></h3>
