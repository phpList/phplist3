...
while ($row = Sql_Fetch_array($res)) {
    ...
    <table class="attributeSet" border="1">
        <tr>
            ...
            <td colspan="2"><?php echo $GLOBALS['I18N']->get('Delete');
                ?> <input type="checkbox" name="delete[<?php echo $row['id'] ?>]" value="1"/></td>
        </tr>
        <tr>
            <td colspan="2"><?php echo $GLOBALS['I18N']->get('Name:');
                ?> </td>
            <td colspan="2"><input type="text" name="name[<?php echo $row['id'] ?>]"
                                   value="<?php echo htmlspecialchars(stripslashes($row['name'])) ?>" size="40"/></td>
        </tr>
        <tr>
            <td colspan="2"><?php echo $GLOBALS['I18N']->get('Type');
                ?> </td>
            <td colspan="2"><input type="hidden" name="type[<?php echo $row['id'] ?>]"
                                   value="<?php echo $row['type'] ?>"/><?php echo $row['type'] ?></td>
        </tr>
        <tr>
            <td colspan="2"><?php echo $GLOBALS['I18N']->get('Default Value:');
                ?> </td>
        ...
        <tr>
            <td><?php echo $GLOBALS['I18N']->get('Order of Listing:');
                ?> </td>
