...
//          "index_1" => array("loginnameidx (loginname)",""),
    ...
    */
    ...
    'linktrack' => array(
        ...
        'urlhash'     => array('binary(32)', 'hash value of URL'),
        'forward'     => array('varchar(2083)', 'URL to forward to'),
...
//          "index_5" => array("miduidurlindex (messageid,userid,url)",""),
        'unique_1' => array('miduidurlindex (messageid,userid,urlhash)', ''),
    ),
    ...
    'bounceregex' => array(
        ...
        'regexhash'   => array('binary(32)', 'hash value of regex'),
